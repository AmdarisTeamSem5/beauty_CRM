...
namespace GNT.Infrastructure.Migrations
{
    ...
    public partial class fresh_migration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "PriceBandOptions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    LowMax = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    MediumMax = table.Column<decimal>(type: "decimal(18,2)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceBandOptions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuccessfullyUsed = table.Column<bool>(type: "bit", nullable: false),
                    FailedAttempts = table.Column<int>(type: "int", nullable: false),
                    Message = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSecurityCode", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserSecurityCode_User_UserId",
                        column: x => x.UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSecurityCode_CreatedAt",
                table: "UserSecurityCode",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_UserSecurityCode_UserId",
                table: "UserSecurityCode",
                column: "UserId");
        }
